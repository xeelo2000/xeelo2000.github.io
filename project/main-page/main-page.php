...
<body>
    ...
    <div id="error-msg">
      ...
      <div>
      <a href= "./jennie/jennie-info.php"><img src="./images/jenniegiffmaker.gif" width="500" height="500"></a>
        <h2>Jennie Kim </h2>
      </div>

      <div>
      <a href= "./jisoo/jisoo-info.php"><img src="./images/jisoogifmaker.gif" width="500" height="500"></a>
        <h2>Jisoo Kim </h2>
      </div>

      <div>
      <a href= "./lisa/lisa-info.php"><img src="./images/lisagifmaker.gif" width="500" height="500"></a>
        <h2>Lisa Manoban </h2>
      </div>

      <div>
      <a href= "./rose/rose-info.php"><img src="./images/roseeeegiffmaker.gif" width="500" height="500"></a>
        <h2>Rosé Park </h2>
      </div> 
